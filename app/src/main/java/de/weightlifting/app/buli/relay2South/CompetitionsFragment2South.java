...
public class CompetitionsFragment2South extends ListViewFragment {
    ...
    protected void getBuliElements() {
        ...
        if (competitions2South.getItems().size() == 0) {
            ...
            try {
                CompetitionsListAdapter adapter = new CompetitionsListAdapter(Competitions.casteArray(competitions2South.getItems()), getActivity());
                ...
                listViewBuli.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        bundle.putString("protocol-url", Competitions.casteArray(competitions2South.getItems()).get(position).getProtocolUrl());
